...
<VideoPlayer src="/videos/sidiAli/video.mp4" poster={coverImage.src} title="SIDI Ali Video Production" />

**Note:** If the video doesn't play, you can [download it directly](/videos/sidiAli/video.mp4) or view it in a dedicated video player. The file may need re-encoding for optimal web compatibility.
