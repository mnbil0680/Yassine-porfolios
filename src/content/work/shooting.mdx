...
<Picture src={coverImage} alt="SIDI Ali Cover" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" />
<Picture src={photo1Image} alt="Photography Sample 1" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" />
<Picture src={photo2Image} alt="Photography Sample 2" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" />
