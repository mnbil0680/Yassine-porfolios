...
<Picture src={brandIdentityImage} alt="SIDI Tour Brand Identity" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" />
<Picture src={culturalPhotoImage} alt="Cultural Photography" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" />
<Picture src={experienceDesignImage} alt="Tourism Experience Design" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" />
<Picture src={storyVisualImage} alt="Story Visual" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" />
