...
| Image | Description |
|-------|-------------|
| <Picture src={azawanPrimary} alt="Radio Azawan Primary Design" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" /> | Main brand identity design featuring the primary logo and visual elements |
| <Picture src={azawanSecondary} alt="Radio Azawan Secondary Design" formats={PICTURE_FORMATS} class:list={["img-thumbnail"]} decoding="async" loading="lazy" /> | Secondary design applications showcasing brand versatility and adaptability |